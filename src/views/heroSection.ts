...
export function HeroSection(): string {
  ...
  return `
  <section class="relative w-full h-[95dvh] mb-15 sm:mb-25 mt-14 lg:mt-18 flex items-center justify-center overflow-hidden 
  bg-gradient-to-br from-indigo-800 via-purple-700 to-pink-700 text-white">
    ...
    <div class="absolute top-1/2 sm:top-1/4 right-10 w-44 h-44 bg-indigo-300/40 rounded-full 
    ...
    <div class="relative z-10 flex flex-col items-center text-center px-6">
      ...
      🎯 Bid on Items You Love <br class="hidden sm:block">
      <h2 class="text-2xl sm:text-4xl font-bold mb-6 text-yellow-300">Anytime. Anywhere.</h2>
      </h1>
